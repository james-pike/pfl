...
export default component$(() => {
  ...
  return (
    <header
      id="header"
      class={`sticky top-0 z-40 flex-none mx-auto w-full border-b-4  border-gray-50/0 transition-[opacity] ease-in-out ${
        store.isScrolling
    ...
    >
      ...
      <div class="relative text-default pt-2 pb-1 px-3 md:px-6 mx-auto w-full md:flex md:justify-between max-w-7xl">
